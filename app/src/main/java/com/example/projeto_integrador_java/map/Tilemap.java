...
import static com.example.projeto_integrador_java.map.MapLayout.NUMBER_OF_COLUMN_TILES;
import static com.example.projeto_integrador_java.map.MapLayout.NUMBER_OF_ROW_TILES;
import static com.example.projeto_integrador_java.map.MapLayout.TILE_HEIGHT_PIXELS;
import static com.example.projeto_integrador_java.map.MapLayout.TILE_WIDTH_PIXELS;
